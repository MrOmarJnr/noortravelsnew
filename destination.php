<?php $head_title="Destination || NoorTravels || NoorTravels PHP Template"?>
...
?>
        ...
        <section class="destination-section pb-100">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-3 col-md-6 col-sm-12">
                        <div class="single-place-item-two mb-30 wow fadeInUp">
                            <div class="place-img">
                                <img src="assets/images/place/place-10.jpg" alt="Place Image">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-12 wow fadeInUp">
                        <div class="single-place-item-two mb-30">
                            <div class="place-img">
                                <img src="assets/images/place/place-16.jpg" alt="Place Image">
                                <span class="tour-count">5 Tours</span>
                                <div class="place-content">
                                    <div class="info text-white">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-12">
                        <div class="single-place-item-two mb-30 wow fadeInUp">
                            <div class="place-img">
                                <img src="assets/images/place/place-18.jpg" alt="Place Image">
                                <span class="tour-count">5 Tours</span>
                                <div class="place-content">
                                    <div class="info text-white">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-12">
                        <div class="single-place-item-two mb-30 wow fadeInUp">
                            <div class="place-img">
                                <img src="assets/images/place/place-19.jpg" alt="Place Image">
                                <span class="tour-count">5 Tours</span>
                                <div class="place-content">
                                    <div class="info text-white">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <ul class="NoorTravels-pagination wow fadeInUp text-center mt-30">
                ...
                <div class="row align-items-center">
                    <div class="col-xl-7 col-lg-8">
                        ...
                        <div class="cta-content-box text-white wow fadeInLeft">
                            ...
                            <a href="about.php" class="main-btn secondary-btn">Check Availability<i class="far fa-paper-plane"></i></a>
                        </div>
                    </div>
            ...
            <div class="container">
                <div class="row align-items-xl-center">
                    <div class="col-xl-5 order-2 order-lg-1">
                        <!--=== Features Image Box ===-->
                        <div class="features-one_image-box mb-30 wow fadeInLeft">
                            <img src="assets/images/features/feat-9.jpg" alt="Features Image">
                        </div>
                    </div>
