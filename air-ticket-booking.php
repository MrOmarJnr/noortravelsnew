<?php $head_title="Air Ticket Booking || NoorTravelsGH.com"?>
<?php require_once('parts/layout/top-layout.php'); ?>
<?php require_once('parts/header/header3.php'); ?>
<?php
$page_title = "Air Ticket Booking";
...
<h3 class="title">Affordable & Reliable Air Ticket Booking</h3>

<div class="meta">
<span class="location"><i class="fas fa-map-marker-alt"></i>Worldwide Flights</span>

</div>

<p>
Noor Travels provides competitive airfare solutions for
individual, family, and corporate travel. We compare airlines
to ensure you get the best fare options available.
</p>
...
<li><span><i class="fas fa-badge-check"></i>Best Fare Comparison</span></li>
<li><span><i class="fas fa-badge-check"></i>Flexible Ticket Options</span></li>
<li><span><i class="fas fa-badge-check"></i>Group & Corporate Booking</span></li>
<li><span><i class="fas fa-badge-check"></i>Rescheduling Assistance</span></li>
<li><span><i class="fas fa-badge-check"></i>Emergency Travel Support</span></li>
<li><span><i class="fas fa-badge-check"></i>24/7 Customer Service</span></li>
</ul>
...
<img src="assets/images/gallery/gal4.png" alt="">
<div class="hover-overlay">
<a href="assets/images/gallery/gal4.png" class="icon-btn img-popup">
...
<div class="single-gallery-item mb-30">
<div class="gallery-img">
<img src="assets/images/gallery/gal5.png" alt="">
<div class="hover-overlay">
<a href="assets/images/gallery/gal5.png" class="icon-btn img-popup">
<i class="far fa-plus"></i>
</a>
</div>
</div>
...
<div class="single-gallery-item mb-30">
<div class="gallery-img">
<img src="assets/images/gallery/gal6.png" alt="">
<div class="hover-overlay">
<a href="assets/images/gallery/gal6.png" class="icon-btn img-popup">
<i class="far fa-plus"></i>
</a>
</div>
</div>
