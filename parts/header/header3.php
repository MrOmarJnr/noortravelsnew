                    ...
                    <div class="row">
                        <div class="col-xl-3 d-none d-xl-block">
                            ...
                            <div class="site-brading">
                                <a href="index-3.php" class="brand-logo"><img src="assets/images/logo/newnewcol.png" alt="Logo"></a>
                            </div>
                        </div>
                                        ...
                                        <div class="single-info-item-two">
                                            <div class="inner-info">
                                                ...
                                                <div class="info">
                                                    ...
                                                    <h5>Hasnem Properties, Tse Addo</h5>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="single-info-item-two">
                                            <div class="inner-info">
                                                ...
                                                <div class="info">
                                                    ...
                                                    <h5><a href="mailto:support@gmail.com">noortravelsgh@gmail.com</a></h5>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-4">
                                        <div class="single-info-item-two">
                                            <div class="inner-info">
                                                ...
                                                <div class="info">
                                                    <span class="title">Ring Us On</span>
                                                    <h5><a href="tel:+000(123)45688">(+233) 55 230 5782 </a></h5>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                ...
                <div class="container-fluid">
                    <div class="primary-menu black-bg">
                        ...
                        <div class="site-brading d-block d-xl-none">
                            <a href="index-3.php" class="brand-logo"><img src="assets/images/logo/newnew.png" alt="Logo"></a>
                        </div>
                        <!--====== Nav Menu ======-->
                        <div class="nav-menu">
                            <!--====== Site Branding ======-->
