<?php $head_title="Organizational Tour || NoorTravelsGH.com"?>
<?php require_once('parts/layout/top-layout.php'); ?>
<?php require_once('parts/header/header3.php'); ?>
<?php
$page_title = "Organizational Tour";
...
<h3 class="title">Corporate & Organizational Tour Services</h3>

<div class="meta">
<span class="location"><i class="fas fa-map-marker-alt"></i>Ghana & International Destinations</span>

</div>

<p>
Noor Travels specializes in organizing professional group travel for
corporate institutions, churches, schools, NGOs, and associations.
We handle every stage of planning,ensuring smooth coordination,
cost-efficiency, and memorable experiences.
</p>
...
<p>
Our team ensures your group trip is professionally managed
from start to finish.
</p>

<ul class="features-list mb-40">
<li><span><i class="fas fa-badge-check"></i>Custom Itinerary Planning</span></li>
<li><span><i class="fas fa-badge-check"></i>Group Flight Booking</span></li>
<li><span><i class="fas fa-badge-check"></i>Hotel & Accommodation</span></li>
<li><span><i class="fas fa-badge-check"></i>Visa Coordination</span></li>
<li><span><i class="fas fa-badge-check"></i>Transportation Logistics</span></li>
<li><span><i class="fas fa-badge-check"></i>Tour Guides & Activities</span></li>
<li><span><i class="fas fa-badge-check"></i>Travel Insurance Support</span></li>
</ul>
...
<img src="assets/images/gallery/gal1.png" alt="">
<div class="hover-overlay">
<a href="assets/images/gallery/gal1.png" class="icon-btn img-popup">
...
<div class="single-gallery-item mb-30">
<div class="gallery-img">
<img src="assets/images/gallery/gal2.png" alt="">
<div class="hover-overlay">
<a href="assets/images/gallery/gal2.png" class="icon-btn img-popup">
<i class="far fa-plus"></i>
</a>
</div>
</div>
...
<div class="single-gallery-item mb-30">
<div class="gallery-img">
<img src="assets/images/gallery/gal3.png" alt="">
<div class="hover-overlay">
<a href="assets/images/gallery/gal3.png" class="icon-btn img-popup">
<i class="far fa-plus"></i>
</a>
</div>
</div>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="section-title text-center mb-45 wow fadeInDown">
                    <h2>Popular Organizational Tour Destinations</h2>
                </div>
            </div>
        </div>
        ...
        <div class="slider-active-3-item-dot wow fadeInUp">
            ...
            <div class="single-place-item mb-60">
                <div class="place-img">
                    <img src="assets/images/gallery/gal1.png" alt="kakum">
                </div>
                <div class="place-content">
                    <div class="info">
                       
                        <h4 class="title">Kakum National Park</h4>
                        <p class="location">
                            <i class="fas fa-map-marker-alt"></i>Cape Coast, Ghana
                        </p>
                        <p class="price">Tour Itinerary Available</p>
                    </div>
                </div>
            </div>
            ...
            <div class="single-place-item mb-60">
                <div class="place-img">
                    <img src="assets/images/gallery/gal2.png" alt="aburi">
                </div>
                <div class="place-content">
                    <div class="info">
                       
                        <h4 class="title">Aburi Botanincal Gardens </h4>
                        <p class="location">
                            <i class="fas fa-map-marker-alt"></i>Aburi, Ghana
                        </p>
                        <p class="price">Tour Itinerary Available</p>
                    </div>
                </div>
            ...
            <div class="single-place-item mb-60">
                <div class="place-img">
                    <img src="assets/images/gallery/gal3.png" alt="akosombo">
                </div>
                <div class="place-content">
                    <div class="info">
                      
                        <h4 class="title">Akosombo Lake Rides</h4>
                        <p class="location">
                            <i class="fas fa-map-marker-alt"></i>Akosombo Eastern Region
                        </p>
                        <p class="price">Tour Itinerary Available</p>
                    </div>
                </div>
